...
<div class="wrap">
  <header>
    ...
    <nav>
      <a href="dashboard.php" style="color:var(--gold);">Dashboard</a>
      <a href="events.php" style="color:var(--muted); margin-left:18px;">Kelola Event</a>
      <a href="logout.php" class="logout" style="margin-left:18px;">Keluar →</a>
    </nav>
  </header>
  ...
  <div class="table-scroll" style="margin-bottom: 40px;">
    <table>
      <tr><th>Event</th><th>Pendaftar</th><th>Pengundang</th></tr>
      <?php foreach ($eventSummary as $ev): ?>
      <tr>
        <td><?= htmlspecialchars($ev['name']) ?></td>
        <td><?= (int)$ev['total_leads'] ?></td>
        <td><?= (int)$ev['total_referrers'] ?></td>
      </tr>
      <?php endforeach; ?>
    </table>
  </div>
  ...
  <div class="table-scroll">
    <table>
      <tr><th>#</th><th>Nama</th><th>WhatsApp</th><th>Kode Link</th><th>Event</th><th>Jumlah Pendaftar</th></tr>
  ...
  <div class="table-scroll">
    <table>
      <tr><th>Waktu</th><th>Nama</th><th>Email</th><th>WhatsApp</th><th>Kota</th><th>Event</th><th>Diundang Oleh</th></tr>
